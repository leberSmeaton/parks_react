  ...
  return (
    <>
      ...
      <section>
        ...
        <div>
          <img src={process.env.PUBLIC_URL + '/picnic_image2.jpg'} alt="melbourne google map" style={{ width: '100%' }} />
          ...
          <p>Prepare to meet some of the finest producers in Australia, including but not limited to:
            <ul>
              <li>Artisans Bend</li>
